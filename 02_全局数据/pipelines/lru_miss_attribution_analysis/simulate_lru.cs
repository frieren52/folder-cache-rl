...
public static class FolderLruAnalysis
{
    ...
    {
        string tables = Path.Combine(root, "02_全局数据", "analysis", "lru_miss_attribution_analysis", "tables");
        ...
        string causesPath = Path.Combine(tables, "miss_cause_summary.csv");
        ...
        string operationalPath = Path.Combine(tables, "miss_operational_state.csv");
        ...
        string waitPath = Path.Combine(tables, "miss_wait_buckets.csv");
        ...
        string diagnosticsPath = Path.Combine(tables, "miss_diagnostics.csv");
        ...
        string topPath = Path.Combine(tables, "miss_top_objects.csv");
